...
import JavaScriptWorker from "worker:./runtime/javascript.worker";
import { style } from "../shared/ww-code-css-single";
import Code from "../shared/ww-code-template";
import { consoleStyle } from "./runtime/console-css";
import {
    ExecuteCodeMessage,
    FromWorkerMessage,
